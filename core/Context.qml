Item {
	...
	function init(options) {
		...
		style.setHtml(
			...
			mangleRule('textarea', "{ position: absolute; visibility: inherit; border-style: solid; border-width: 0px; }") +
			mangleRule('textarea:focus', "{outline: none;}") +
			mangleRule('input', "{ position: absolute; visibility: inherit; border-style: solid; border-width: 0px; }") +
