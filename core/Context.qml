Item {
	...
	function init(html) {
		...
		$('head').append($("<style>" +
			...
			"div " + "{ position: absolute; border-style: solid; border-width: 0px; white-space: nowrap; border-radius: 0px; opacity: 1.0; transform: none; left: 0px; top: 0px; width: 0px; height: 0px; -webkit-backface-visibility:hidden; -webkit-transform: translateZ( 0 ); } " +
