...
Object {
	...
	onPointSizeChanged:		{ this.parent.style('font-size', value? value + 'pt': ''); if (value) this.pixelSize = 0; this.parent._updateSize() }
	onPixelSizeChanged:		{ this.parent.style('font-size', value? value + 'px': ''); if (value) this.pointSize = 0; this.parent._updateSize() }
