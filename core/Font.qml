...
Object {
	...
	onPointSizeChanged:		{ this.parent.style('font-size', value? value + 'pt': ''); this.pixelSize = 0; this.parent._updateSize() }
	onPixelSizeChanged:		{ this.parent.style('font-size', value? value + 'px': ''); this.pointSize = 0; this.parent._updateSize() }
