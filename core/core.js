...
//			case 'rotate':
	...
	_globals.core.core.Context.prototype.init = function(html) {
		...
		$('head').append($("<style>" +
			...
			"div { position: absolute; border-style: solid; border-width: 0px; white-space: nowrap; left: 0px; top: 0px; width: 0px; height: 0px; border-radius: 0px; opacity: 1.0; transform: none; } " +
