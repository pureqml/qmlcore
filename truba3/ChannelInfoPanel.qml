Item {
	...
	Behavior on x { animation: Animation { id: panelXAnimation; duration: 300; } }
	Behavior on y { animation: Animation { id: panelYAnimation; duration: 300; } }
	Behavior on width { animation: Animation { id: panelWidthAnimation; duration: 300; } }
}
